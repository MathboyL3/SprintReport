...
% Autor(a) do trabalho
\autor{Daniel Alivan de Oliveira Curi\\Ryan Luciano de Oliveira e Silva\\ Náthan Luciano de Oliveira e Silva\\João César Carvalho Júnior}

% Título do Trabalho
\titulo{Relatório Sprint 004}
...
\input{Partes/TecnologiasUtilizadas.tex}
\input{Partes/Desenvolvimento.tex}
\input{Partes/PlanoDeTestes.tex}
